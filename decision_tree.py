...
dim_list = [2, 10, 20, 50, 100]
accuracy_mean_list = []
accuracy_std_list = []
for dim in dim_list:
    print('-----------------------------------')
    print("the dim is: ", dim)
    pca = PCA(n_components=dim).fit(data_numpy_train)
...
plt.rcParams['font.sans-serif'] = 'SimHei'
plt.figure(figsize=(6, 6))
plt.xlabel('The dimension of pca')
plt.ylabel('The accuracy')
plt.errorbar(dim_list, accuracy_mean_list, accuracy_std_list, fmt='-o')
